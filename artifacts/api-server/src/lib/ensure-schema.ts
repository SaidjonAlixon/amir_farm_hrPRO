...
ALTER TABLE kpi_settings ADD COLUMN IF NOT EXISTS office_latitude DOUBLE PRECISION;
ALTER TABLE kpi_settings ADD COLUMN IF NOT EXISTS office_longitude DOUBLE PRECISION;
ALTER TABLE kpi_settings ADD COLUMN IF NOT EXISTS office_label TEXT;
UPDATE kpi_settings SET
  office_latitude = COALESCE(office_latitude, 41 + 21.0/60 + 5.5/3600),
  office_longitude = COALESCE(office_longitude, 69 + 23.0/60 + 6.7/3600),
  office_label = COALESCE(office_label, 'Asosiy ofis · 41°21''05.5"N 69°23''06.7"E')
WHERE id = 1;
